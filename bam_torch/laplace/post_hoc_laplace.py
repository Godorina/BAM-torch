...
from bam_torch.utils.utils import date, get_dataloader
...
class PostHocLaplace(Evaluator):
    ...
    def laplace_approximate(self, dict_key_y="energy"):
        ...
        )  # or train_scale_shift
        e_corr = e_corr.flatten().mean()
        scale_info = {"e_corr": e_corr, "enr_avg_per_element": self.enr_avg_per_element}
        ...
        for i, data in enumerate(self.data_loader):
            ...
            self.logger.print_epoch_loss(
                step_dict, loss_dict_raw_model, loss_dict_laplace, true_enr
            )
...
from bam_torch.utils.utils import find_input_json
